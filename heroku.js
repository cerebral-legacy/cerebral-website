...
if (process.env.NODE_ENV === 'production') {
  ...
  return child_process.exec("webpack -p --config webpack.production.config.js && webpack -p --config webpack.server.production.config.js", function (error, stdout, stderr) {

...
export default function DefiningSignals() {
  return (
    <div>
      ...
      <GithubCode url="https://github.com/cerebral/cerebral-website-tutorial-basic/blob/master/src/signals/newItemTitleSubmitted.js" />
      ...
      <Markdown filename="doc_defining_signals4.md" />

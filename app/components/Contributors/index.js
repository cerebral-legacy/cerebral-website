...
const contributors = [{
  ...
  name: 'Saul',
  description: 'Saul jumped on to our Vienna event and has since been an eager contributor. Being a structured guy he helps a lot on cleaning up everything from code, to issues to documentation',
  imageLink: 'saul.jpg',
  githubLink: null
}, {
  name: 'Max',
  description: 'The useragent module has been built by Max. He also brings a lot of conceptual thoughts to the table and has some really good one liners!',
  imageLink: 'max.jpg',
  githubLink: null
}]
